        ...
        <div class="w-full pr-1.5 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <div class="text-xs text-gray-700 uppercase  dark:bg-gray-700 dark:text-gray-400">
                <div class=" w-full pr-16 flex items-center p-4">
                            <form action="{{ route('admin.users.index') }}"  method="get" id="searchForm" class="flex items-center">
            ...
            <tbody>
                ...
                @forelse ($userdata as $data)
                        ...
                        <tr
                            ...
                            <td scope="row" class="m-4 flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                <img class="w-10 h-10 rounded-full" src="{{ $data->profile_photo_url }}" >
                                <div class="ps-8">
                                    <div class="text-base font-semibold">{{ $data->name }}</div>
                                </div>  
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-base font-semibold">{{ $data->role->name }}</div>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="px-2">
                                        <form action="{{ route('admin.users.show',  ['user'=>Crypt::encrypt( $data->id)]) }}">
