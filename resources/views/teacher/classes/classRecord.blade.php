                    ...
                    <thead
                        ...
                        <tr class=" border-b-2 border-r-2 border-gray-400 ">
                            ...
                            <th>
                                ...
                                <form id="filterForm" method="GET" action="{{ route('teacher.classes.pdf',Crypt::encrypt($id)) }}" >
                            ...
                            <th>
                                ...
                                class=" ml-4  bold focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
