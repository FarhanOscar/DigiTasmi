...
<div class=" mr-36 lg:mt-4 pr-12 ">
  <div class="lg:pt-24  pr-24 text-left text-2xl font-semibold">{{ $user->name }}</div>
                        <div class="text-left  font-semibold text-gray-500">{{ $user->PhoneNumber }}</div>
                        <div class="text-left  font-semibold text-gray-500">{{ $class->ClassName }}</div>
                    </div>
            </div>
